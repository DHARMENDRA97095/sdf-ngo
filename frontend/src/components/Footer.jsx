    ...
    <footer className="bg-primary text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          {/* Organization Info */}
          <div>
            <img className=" mb-4 " src="logo/logo-bg.png"></img>
        ...
        <div className="border-t border-white/20 pt-8 mt-8 flex justify-center items-center text-xs text-gray-200 text-center">
          <p>
            &copy; {new Date().getFullYear()} S D Foundation. All rights
            reserved || Digital Creators
          </p>
        </div>
      </div>
    </footer>
